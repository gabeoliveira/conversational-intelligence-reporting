...
function friendlyMetricName(name: string): string {
  ...
  // Known metrics with explicit friendly names (Portuguese for customer-facing)
  const displayNames: Record<string, string> = {
    ...
    'poc_ai_retention_rate_percent': 'Taxa de Retenção da IA (%)',
    'poc_csat_avg': 'CSAT Médio',
    'poc_error_rate_percent': 'Taxa de Erros da IA (%)',
    'poc_asked_for_human_rate_percent': 'Solicitou Humano (%)',
    'poc_back_to_ivr_rate_percent': 'Retorno à URA (%)',
    'poc_handoff_customer_request': 'Transbordo: Solicitação do Cliente',
    'poc_handoff_lack_of_comprehension': 'Transbordo: Falta de Compreensão',
    'poc_handoff_lack_of_knowledge': 'Transbordo: Falta de Conhecimento',
    'poc_handoff_total': 'Total de Transbordos',
    'poc_handoff_customer_request_rate_percent': 'Transbordo: Solicitação do Cliente (%)',
    'poc_handoff_lack_of_comprehension_rate_percent': 'Transbordo: Falta de Compreensão (%)',
    'poc_handoff_lack_of_knowledge_rate_percent': 'Transbordo: Falta de Conhecimento (%)',
    ...
    'kpi_precisao_avg': 'Precisão',
    'kpi_cobertura_conhecimento_avg': 'Cobertura de Conhecimento',
    'kpi_alucinacoes_avg': 'Alucinações',
    'kpi_compreensao_avg': 'Compreensão',
    'kpi_aderencia_avg': 'Aderência',
    'kpi_desambiguador_rate_percent': 'Taxa de Desambiguação (%)',
  };
